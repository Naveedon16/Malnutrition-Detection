...
model_filename = "D:/Naveed/Clg/internships/YUCI/Farman/Malnutrition-Detection-Project-using-ML-main/Malnutrition-Detection-Project-using-ML-main/new_svm_with_grid_search.joblib"
loaded_pipeline = joblib.load(model_filename)

@app.get("/Predict")
def predict(Sex: str, Age: int, Height: float, Weight: float):
